...
if __name__ == '__main__':
    ...
    src_train = os.path.join(AEGNN_DATA_DIR, 'original_ncars/Prophesee_Dataset_n_cars/n-cars_train')
    src_test  = os.path.join(AEGNN_DATA_DIR, 'original_ncars/Prophesee_Dataset_n_cars/n-cars_test')
    dst_train = os.path.join(AEGNN_DATA_DIR, 'ncars/training')
    dst_test  = os.path.join(AEGNN_DATA_DIR, 'ncars/test')
    ...
    # dst_val = '/space/yyang22/datasets/data/storage/ncars/validation'
