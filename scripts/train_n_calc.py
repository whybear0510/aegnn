...
# eg: CUDA_VISIBLE_DEVICES=2 python3 ../evaluation/async_accuracy.py /users/yyang22/thesis/aegnn_project/aegnn_results/training_results/checkpoints/ncars/recognition/20230324165706/epoch=59-step=12179.pt --device cuda --dataset ncars --batch-size 1 --test-samples 100
